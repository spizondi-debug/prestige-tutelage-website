...
import QualificationCatalogue from '../components/QualificationCatalogue.jsx'
import { AVAILABILITY_DISCLAIMER, learnerships, technicalInterventions, customCorporate } from '../data/programmes.js'
...
export default function Programmes() {
  ...
  return (
    <>
      ...
      <QualificationCatalogue id="catalogue" className="scroll-mt-28 bg-cloud py-16 lg:py-20" />
