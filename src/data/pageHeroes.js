...
export const pageHeroes = {
  ...
  about: [P.cohortOutside, P.intake, P.certificatesGroup, P.handoverReviewing],
  programmes: [P.angleGrinder, P.workshopTraining, P.trainingRoom, P.cohortOutside],
  ...
  insights: [P.intake, P.handoverRedShirt, P.handoverReviewing, P.cohortOutside],
